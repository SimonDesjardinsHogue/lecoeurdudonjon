...
export const shopItems = [
    ...
    { name: 'Épée Runique', icon: '⚔️', description: '10 de dégât\n✨ +1 Force', cost: 550, category: 'equipment', type: 'weapon', classRestriction: 'guerrier', bonus: 10, rarity: 'epique', effect: null },
    { name: 'Épée Légendaire', icon: '⚔️', description: '12 de dégât\n✨ +1 Force', cost: 850, category: 'equipment', type: 'weapon', classRestriction: 'guerrier', bonus: 12, rarity: 'legendaire', effect: null },
    { name: 'Épée Divine', icon: '⚔️', description: '15 de dégât\n✨ +1 Force', cost: 1250, category: 'equipment', type: 'weapon', classRestriction: 'guerrier', bonus: 15, rarity: 'legendaire', effect: null },
    { name: 'Épée Céleste', icon: '⚔️', description: '18 de dégât\n✨ +1 Force', cost: 1800, category: 'equipment', type: 'weapon', classRestriction: 'guerrier', bonus: 18, rarity: 'legendaire', effect: null },
    { name: 'Épée du Conquérant Suprême', icon: '⚔️', description: '22 de dégât\n✨ +1 Force', cost: 2500, category: 'equipment', type: 'weapon', classRestriction: 'guerrier', bonus: 22, rarity: 'legendaire', effect: null },
    ...
    { name: 'Arc Runique', icon: '🏹', description: '10 de dégât\n✨ +1 Force', cost: 550, category: 'equipment', type: 'weapon', classRestriction: 'archer', bonus: 10, rarity: 'epique', effect: null },
    { name: 'Arc Légendaire', icon: '🏹', description: '12 de dégât\n✨ +1 Force', cost: 850, category: 'equipment', type: 'weapon', classRestriction: 'archer', bonus: 12, rarity: 'legendaire', effect: null },
    { name: 'Arc du Chasseur Divin', icon: '🏹', description: '15 de dégât\n✨ +1 Force', cost: 1250, category: 'equipment', type: 'weapon', classRestriction: 'archer', bonus: 15, rarity: 'legendaire', effect: null },
    { name: 'Arc Céleste', icon: '🏹', description: '18 de dégât\n✨ +1 Force', cost: 1800, category: 'equipment', type: 'weapon', classRestriction: 'archer', bonus: 18, rarity: 'legendaire', effect: null },
    ...
    { name: 'Armure Enchantée', icon: '🛡️', description: '+10 Défense', cost: 510, category: 'equipment', type: 'armor', bonus: 10, rarity: 'epique', effect: null },
    { name: 'Armure Runique', icon: '🛡️', description: '+12 Défense', cost: 800, category: 'equipment', type: 'armor', bonus: 12, rarity: 'legendaire', effect: null },
    { name: 'Armure Divine', icon: '🛡️', description: '+15 Défense', cost: 1200, category: 'equipment', type: 'armor', bonus: 15, rarity: 'legendaire', effect: null },
    { name: 'Armure Céleste', icon: '🛡️', description: '+18 Défense', cost: 1700, category: 'equipment', type: 'armor', bonus: 18, rarity: 'legendaire', effect: null },
    { name: 'Armure Immortelle', icon: '🛡️', description: '+22 Défense', cost: 2400, category: 'equipment', type: 'armor', bonus: 22, rarity: 'legendaire', effect: null }
];
